...
int32_t qws_event_simple_len(int32_t type) {
    switch (type) {
    case QWS_EVT_NOEVENT:
        return 0;
    case QWS_EVT_CONNECTED:
        return (int32_t)sizeof(qws_evt_connected_t);
    case QWS_EVT_MOUSE:
        return (int32_t)sizeof(qws_evt_mouse_t);
    case QWS_EVT_FOCUS:
        return (int32_t)sizeof(qws_evt_focus_t);
    case QWS_EVT_KEY:
        return (int32_t)sizeof(qws_evt_key_t);
    case QWS_EVT_REGION:
        return (int32_t)sizeof(qws_evt_region_t);
    case QWS_EVT_CREATION:
        return (int32_t)sizeof(qws_evt_creation_t);
    case QWS_EVT_PROPERTY_NOTIFY:
        return (int32_t)sizeof(qws_evt_property_notify_t);
    case QWS_EVT_PROPERTY_REPLY:
        return (int32_t)sizeof(qws_evt_property_reply_t);
    case QWS_EVT_MAX_WINDOW_RECT:
        return (int32_t)sizeof(qws_evt_max_window_rect_t);
    case QWS_EVT_WINDOW_OPERATION:
        return (int32_t)sizeof(qws_evt_window_operation_t);
    case QWS_EVT_EMBED:
        return (int32_t)sizeof(qws_evt_embed_t);
    case QWS_EVT_SELECTION_CLEAR:
        return (int32_t)sizeof(qws_evt_selection_clear_t);
    case QWS_EVT_SELECTION_REQUEST:
        return (int32_t)sizeof(qws_evt_selection_request_t);
    case QWS_EVT_SELECTION_NOTIFY:
        return (int32_t)sizeof(qws_evt_selection_notify_t);
    case QWS_EVT_QCOP_MESSAGE:
        return (int32_t)sizeof(qws_evt_qcop_message_t);
    case QWS_EVT_IM_EVENT:
        return (int32_t)sizeof(qws_evt_im_event_t);
    case QWS_EVT_IM_QUERY:
        return (int32_t)sizeof(qws_evt_im_query_t);
    case QWS_EVT_IM_INIT:
        return (int32_t)sizeof(qws_evt_im_init_t);
    case QWS_EVT_FONT:
        return (int32_t)sizeof(qws_evt_font_t);
    case QWS_EVT_SCREEN_TRANSFORM:
        return (int32_t)sizeof(qws_evt_screen_transform_t);
    default:
        return -1;
    }
}
...
int32_t qws_command_simple_len(int32_t type) {
    ...
    case QWS_CMD_REGION_MOVE:
        return (int32_t)sizeof(qws_cmd_region_move_t);
    case QWS_CMD_REGION_DESTROY:
        return (int32_t)sizeof(qws_cmd_region_destroy_t);
    case QWS_CMD_SET_PROPERTY:
        return (int32_t)sizeof(qws_cmd_set_property_t);
    case QWS_CMD_ADD_PROPERTY:
        return (int32_t)sizeof(qws_cmd_add_property_t);
    case QWS_CMD_REMOVE_PROPERTY:
        return (int32_t)sizeof(qws_cmd_remove_property_t);
    case QWS_CMD_GET_PROPERTY:
        return (int32_t)sizeof(qws_cmd_get_property_t);
    case QWS_CMD_SET_SELECTION_OWNER:
        return (int32_t)sizeof(qws_cmd_set_selection_owner_t);
    case QWS_CMD_CONVERT_SELECTION:
        return (int32_t)sizeof(qws_cmd_convert_selection_t);
    case QWS_CMD_REQUEST_FOCUS:
        return (int32_t)sizeof(qws_cmd_request_focus_t);
    case QWS_CMD_CHANGE_ALTITUDE:
        return (int32_t)sizeof(qws_cmd_change_altitude_t);
    case QWS_CMD_SET_OPACITY:
        return (int32_t)sizeof(qws_cmd_set_opacity_t);
    case QWS_CMD_DEFINE_CURSOR:
        return (int32_t)sizeof(qws_cmd_define_cursor_t);
    case QWS_CMD_SELECT_CURSOR:
        return (int32_t)sizeof(qws_cmd_select_cursor_t);
    case QWS_CMD_POSITION_CURSOR:
        return (int32_t)sizeof(qws_cmd_position_cursor_t);
    case QWS_CMD_GRAB_MOUSE:
        return (int32_t)sizeof(qws_cmd_grab_mouse_t);
    case QWS_CMD_PLAY_SOUND:
        return (int32_t)sizeof(qws_cmd_play_sound_t);
    case QWS_CMD_QCOP_REGISTER:
        return (int32_t)sizeof(qws_cmd_qcop_register_t);
    case QWS_CMD_QCOP_SEND:
        return (int32_t)sizeof(qws_cmd_qcop_send_t);
    case QWS_CMD_REGION_NAME:
        return (int32_t)sizeof(qws_cmd_region_name_t);
    case QWS_CMD_IDENTIFY:
        return (int32_t)sizeof(qws_cmd_identify_t);
    case QWS_CMD_GRAB_KEYBOARD:
        return (int32_t)sizeof(qws_cmd_grab_keyboard_t);
    case QWS_CMD_REPAINT_REGION:
        return (int32_t)sizeof(qws_cmd_repaint_region_t);
    case QWS_CMD_IM_MOUSE:
        return (int32_t)sizeof(qws_cmd_im_mouse_t);
    case QWS_CMD_IM_UPDATE:
        return (int32_t)sizeof(qws_cmd_im_update_t);
    case QWS_CMD_IM_RESPONSE:
        return (int32_t)sizeof(qws_cmd_im_response_t);
    case QWS_CMD_EMBED:
        return (int32_t)sizeof(qws_cmd_embed_t);
    case QWS_CMD_FONT:
        return (int32_t)sizeof(qws_cmd_font_t);
    case QWS_CMD_SCREEN_TRANSFORM:
        return (int32_t)sizeof(qws_cmd_screen_transform_t);
    default:
        return -1;
    }
}
...
size_t qws_packet_wire_size(const qws_packet_t *pkt) {
    return QWS_WIRE_HEADER_SIZE + (size_t)pkt->header.simple_len +
...
int qws_display_paths_fill(int display, qws_display_paths_t *paths) {
    if (snprintf(paths->base, sizeof(paths->base), "/tmp/qtembedded-%d",
                 display) >= (int)sizeof(paths->base))
        return -1;
    ...
    if (snprintf(paths->fonts, sizeof(paths->fonts), "%s/fonts", paths->base) >=
        (int)sizeof(paths->fonts))
        return -1;
...
static int rm_entry_cb(const char *path, const struct stat *st, int typeflag,
                       struct FTW *ftwbuf) {
    (void)st;
    (void)typeflag;
    (void)ftwbuf;
...
static int parse_qpf_filename(const char *basename, char *family,
                              size_t family_sz, int *pixelsize, int *weight,
                              bool *italic) {
...
static int write_font_entry(FILE *f, const char *family, const char *foundry,
    ...
    return qws_fwrite_qdatastream_qstring(f, family)     /* familyname      */
           ...
           || qws_fwrite_qdatastream_bytearray(
                  f, filepath, (int32_t)strlen(filepath)) /* file      */
...
int qws_build_font_database(const char *fontdb_path) {
    ...
    if (dir) {
        ...
        while ((de = readdir(dir)) != NULL) {
            ...
            bool italic;
            if (parse_qpf_filename(name, family, sizeof(family), &pixelsize,
                                   &weight, &italic) != 0)
                continue;
            ...
            if (write_font_entry(f, family, "qt", weight, italic, pixelsize,
                                 abspath) != 0) {
                closedir(dir);
                goto err;
            }
...
const char *qws_surface_flag_name(int flag) {
    switch (flag) {
    case QWS_SURFACE_REGION_RESERVED:
        return "RegionReserved";
    case QWS_SURFACE_BUFFERED:
        return "Buffered";
    case QWS_SURFACE_OPAQUE:
        return "Opaque";
    default:
        return "Unknown";
    }
...
const char *qws_im_update_type_name(int type) {
    switch (type) {
    case QWS_IM_FOCUS_IN:
        return "FocusIn";
    case QWS_IM_FOCUS_OUT:
        return "FocusOut";
    case QWS_IM_UPDATE:
        return "Update";
    case QWS_IM_DICTATION:
        return "Dictation";
    default:
        return "Unknown";
    }
...
const char *qws_image_format_name(int format) {
    switch (format) {
    case QWS_FORMAT_INVALID:
        return "Invalid";
    case QWS_FORMAT_MONO:
        return "Mono";
    case QWS_FORMAT_MONO_LSB:
        return "MonoLSB";
    case QWS_FORMAT_INDEXED8:
        return "Indexed8";
    case QWS_FORMAT_RGB32:
        return "RGB32";
    case QWS_FORMAT_ARGB32:
        return "ARGB32";
    case QWS_FORMAT_ARGB32_PREMULTIPLIED:
        return "ARGB32_Premultiplied";
    case QWS_FORMAT_RGB16:
        return "RGB16";
    case QWS_FORMAT_ARGB8565_PREMULTIPLIED:
        return "ARGB8565_Premultiplied";
    case QWS_FORMAT_RGB666:
        return "RGB666";
    case QWS_FORMAT_ARGB6666_PREMULTIPLIED:
        return "ARGB6666_Premultiplied";
    case QWS_FORMAT_RGB555:
        return "RGB555";
    case QWS_FORMAT_ARGB8555_PREMULTIPLIED:
        return "ARGB8555_Premultiplied";
    case QWS_FORMAT_RGB888:
        return "RGB888";
    case QWS_FORMAT_RGB444:
        return "RGB444";
    case QWS_FORMAT_ARGB4444_PREMULTIPLIED:
...
const char *qws_window_type_str(uint32_t flags) {
    ...
    case QWS_WT_TOOLTIP:
        return "ToolTip";
    case QWS_WT_SPLASHSCREEN:
        return "SplashScreen";
    case QWS_WT_DESKTOP:
        return "Desktop";
    case QWS_WT_SUBWINDOW:
        return "SubWindow";
    default:
        return "Unknown";
    }

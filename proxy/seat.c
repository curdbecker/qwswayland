...
static uint32_t keysym_to_qt_key(xkb_keysym_t sym)
{
    ...
    static const uint32_t keytbl[] = {
        ...
        XKB_KEY_Shift_R,              0x01000020u,
        XKB_KEY_Shift_Lock,           0x01000020u,
        XKB_KEY_Control_L,            0x01000021u, /* Qt::Key_Control */
        XKB_KEY_Control_R,            0x01000021u,
        XKB_KEY_Meta_L,               0x01000022u, /* Qt::Key_Meta */
        XKB_KEY_Meta_R,               0x01000022u,
        XKB_KEY_Alt_L,                0x01000023u, /* Qt::Key_Alt */
        XKB_KEY_Alt_R,                0x01000023u,
        XKB_KEY_Caps_Lock,            0x01000024u, /* Qt::Key_CapsLock */
        ...
        XKB_KEY_dead_semivoiced_sound,0x0100125fu, /* Qt::Key_Dead_Semivoiced_Sound */
                           ...
                           uint32_t key, uint32_t key_state)
{
    ...
    xkb_keysym_t keysym = xkb_state_key_get_one_sym(kbd_state->xkb_state, key + 8);
    UChar utf16[2];
    ...
    if (!is_press) {
        if (key == kbd_state->repeat_key)
            kbd_repeat_disarm(kbd_state);
    } else if (kbd_state->repeat_timerfd >= 0
               && kbd_state->repeat_rate > 0
        ...
        struct itimerspec ts = {
            .it_value    = { .tv_sec  =  kbd_state->repeat_delay / 1000,
                             .tv_nsec = (kbd_state->repeat_delay % 1000) * 1000000L },
